...
export default function App() {
  ...
  // Auto-derive LALA records from all records containing "LALA"
            ...
            <div style={{overflowX:"auto"}}>
              <table style={{width:"100%",borderCollapse:"collapse",fontSize:"13px"}}>
                <thead><tr style={{background:"rgba(255,255,255,0.06)"}}>
                  {["來源","日期","說明","付款方式","金額","發票/收據","操作"].map(h=><th key={h} style={{padding:"10px 12px",textAlign:"left",color:"#888",fontWeight:"600",borderBottom:"1px solid rgba(255,255,255,0.1)",whiteSpace:"nowrap"}}>{h}</th>)}
                </tr></thead>
                <tbody>
                  {allLalaRecords.length===0&&<tr><td colSpan={7} style={{padding:"40px",textAlign:"center",color:"#555"}}>尚無紀錄</td></tr>}
